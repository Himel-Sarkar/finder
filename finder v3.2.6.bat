...
curl -s https://www.threatcrowd.org/searchApi/v2/domain/report/?domain=%ip%

echo ========================================================= Bufferover =========================================================================
curl -s "https://dns.bufferover.run/dns?q=.%ip%

echo ========================================================= Web Archive =======================================================================
curl -s "http://web.archive.org/cdx/search/cdx?url=*.%ip%/*&output=text&fl=original&collapse=urlkey"
echo ========================================================= dns_names and issuer and expire Date ==============================================================
curl -s https://api.certspotter.com/v1/issuances?domain=%ip%"&"expand=dns_names"&"expand=issuer
pause >> nul
